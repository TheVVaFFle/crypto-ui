...
const config = {
  entry: {
    bundle: path.resolve(__dirname, 'client/init.jsx')
  },
  output: {
  ...
  plugins: [
    new htmlWebpackPlugin({template: path.resolve(__dirname, 'client/index.pug')}),
    new copyWebpackPlugin([{from: path.resolve(__dirname, 'client/img'), to: 'img'}]),
